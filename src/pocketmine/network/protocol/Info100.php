...
interface Info100{
	 ...
	 */
	public const CURRENT_PROTOCOL = 102;
	public const ACCEPTED_PROTOCOLS = [100, 101, 102];

	public const MINECRAFT_VERSION = ["v1.0.0","v1.0.3","v1.0.4"];
	...
	public const PLAYER_FALL_PACKET = 0x25;
	...
	public const EVENT_PACKET = 0x40; //TelemetryEventPacket
	public const SPAWN_EXPERIENCE_ORB_PACKET = 0x41;
	public const CLIENTBOUND_MAP_ITEM_DATA_PACKET = 0x42; //MapItemDataPacket
	...
	public const REPLACE_ITEM_IN_SLOT_PACKET = 0x47; //ReplaceSelectedItemPacket
