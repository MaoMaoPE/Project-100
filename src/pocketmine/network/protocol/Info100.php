...
interface Info100{
	...
	//const BLOCK_PICK_REQUEST_PACKET = 0xFF;
	...
	//const COMMAND_BLOCK_UPDATE_PACKET = 0xFF;
	...
	//const PLAY_SOUND_PACKET = 0xFF;
	//const STOP_SOUND_PACKET = 0xFF;
	//const SET_TITLE_PACKET = 0xFF;
